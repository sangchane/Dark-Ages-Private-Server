...
{
    /// <summary>
    /// 홀리드래곤 — 5.99 `Jigja.txt` 의 SPELL_홀리드래곤 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("홀리드래곤", "5.99표")]
    public class SpellD640B9ACB4DCB798ACE4 : SpellScript
    {
        public SpellD640B9ACB4DCB798ACE4(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            p.Call("message", (V)3L, (V)"홀리드래곤을 외웠습니다.");
            ...
            for (v_i = v_x1; V.T(((V)(v_i) <= (V)(v_x2))); v_i = ((V)(v_i) + (V)((V)1L)))
            {
                for (v_j = v_y1; V.T(((V)(v_j) <= (V)(v_y2))); v_j = ((V)(v_j) + (V)((V)1L)))
                {
                    ...
                    {
                        p.Call("effect", v_mob, (V)0L, (V)89L, (V)100L);
