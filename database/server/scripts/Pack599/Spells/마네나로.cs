...
{
    /// <summary>
    /// 마네나로 — 5.99 `법사(비전직).txt` 의 SPELL_마네나로 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("마네나로", "5.99표")]
    public class SpellB9C8B124B098B85C : SpellScript
    {
        public SpellB9C8B124B098B85C(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            {
                p.Call("message", (V)3L, (V)"사용하기에 마력량이적습니다. [필요마나 : 500이상]");
                return;
            }
            p.Call("manal_del", (V)"500");
            p.Call("message", (V)3L, (V)"마네나로를 외웠습니다.");
            p.Call("game_sound", (V)63L, (V)0L);
            v_damage = ((V)(((V)(p.Call("get_mgc_damage", v_myid)) / (V)((V)20L))) * (V)((V)19L));
            if (V.T(p.Call("get_critical", v_myid)))
            {
                v_damage = ((V)(v_damage) * (V)((V)5L));
            }
            ...
            for (v_i = v_x1; V.T(((V)(v_i) <= (V)(v_x2))); v_i = ((V)(v_i) + (V)((V)1L)))
            {
                for (v_j = v_y1; V.T(((V)(v_j) <= (V)(v_y2))); v_j = ((V)(v_j) + (V)((V)1L)))
                {
                    ...
                    {
                        p.Call("effect", v_mob, (V)0L, (V)10L, (V)75L);  // 노바 이펙트(5.99: 0, 236, 속도 75)
