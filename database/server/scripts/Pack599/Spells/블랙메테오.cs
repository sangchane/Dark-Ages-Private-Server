...
namespace Darkages.Storage.locales.Scripts.Pack599
{
    ...
    {
        public SpellBE14B799BA54D14CC624(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            p.Call("message", (V)3L, (V)"블랙메테오를 외웠습니다.");
            p.Call("game_sound", (V)63L, (V)0L);
            v_damage = ((V)(((V)(p.Call("get_mana", v_myid)) / (V)((V)4L))) * (V)((V)7L));
            v_x1 = ((V)(p.Call("get_xs", v_myid)) - (V)((V)9L));
            v_x2 = ((V)(p.Call("get_xs", v_myid)) + (V)((V)9L));
            v_y1 = ((V)(p.Call("get_ys", v_myid)) - (V)((V)9L));
            v_y2 = ((V)(p.Call("get_ys", v_myid)) + (V)((V)9L));
