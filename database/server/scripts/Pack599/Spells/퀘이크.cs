...
{
    /// <summary>
    /// 퀘이크 — 5.99 `Wizard.txt` 의 SPELL_퀘이크 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("퀘이크", "5.99표")]
    public class SpellD018C774D06C : SpellScript
    {
        public SpellD018C774D06C(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            {
                p.Call("effect", v_target, (V)0L, (V)103L, (V)75L);
            ...
            else
            {
                if (V.T(V.B(V.T(((V)(v_type) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    {
                        p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 퀘이크를 가합니다.")));
                    }
                }
            }
            p.Call("effect", v_target, (V)0L, (V)103L, (V)75L);
            p.Call("message", (V)3L, (V)"퀘이크를 외웠습니다.");
            p.Call("motion", (V)136L, (V)75L);
            p.Call("game_sound", (V)76L, (V)0L);
        }
    }
}
