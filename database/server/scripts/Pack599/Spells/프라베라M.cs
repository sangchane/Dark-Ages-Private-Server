...
{
    /// <summary>
    /// 프라베라M — 5.99 `Wizard.txt` 의 SPELL_프라베라M 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("프라베라M", "5.99표")]
    public class SpellD504B77CBCA0B77C004D : SpellScript
    {
        public SpellD504B77CBCA0B77C004D(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            v_x1 = ((V)(p.Call("get_xs", v_myid)) - (V)((V)12L));
            v_x2 = ((V)(p.Call("get_xs", v_myid)) + (V)((V)12L));
            v_y1 = ((V)(p.Call("get_ys", v_myid)) - (V)((V)12L));
            v_y2 = ((V)(p.Call("get_ys", v_myid)) + (V)((V)12L));
