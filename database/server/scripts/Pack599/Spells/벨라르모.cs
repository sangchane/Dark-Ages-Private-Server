...
{
    /// <summary>
    /// 벨라르모 — 노바 `성직자(비전직).txt` 의 SPELL_벨라르모 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("벨라르모", "5.99표")]
    public class SpellBCA8B77CB974BAA8 : SpellScript
    {
        public SpellBCA8B77CB974BAA8(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            p.Call("belra", v_target, (V)120L, (V)7L);
            p.Call("game_sound", (V)8L, (V)0L);
            p.Call("message", (V)3L, (V)"벨라르모를 외웠습니다.");
            p.Call("effect", v_target, (V)93L, (V)93L, (V)100L);
            if (V.T(((V)(v_target) == (V)(v_myid))))
            {
                return;
            }
            p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 벨라르모를 외워주셨습니다.")));
        }
    }
}
