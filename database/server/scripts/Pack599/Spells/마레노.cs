...
{
    /// <summary>
    /// 마레노 — 5.99 `법사(비전직).txt` 의 SPELL_마레노 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("마레노", "5.99표")]
    public class SpellB9C8B808B178 : SpellScript
    {
        public SpellB9C8B808B178(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            if (V.T(((V)(p.Call("spell_exist", (V)"원소이해력")) == (V)((V)1L))))
            {
                ...
                v_damage = ((V)(((V)(p.Call("get_mgc_damage", v_myid)) / (V)((V)10L))) * (V)((V)19L));
            }
            else
            {
                ...
                v_damage = ((V)(((V)(p.Call("get_mgc_damage", v_myid)) / (V)((V)10L))) * (V)((V)16L));
            }
            ...
            {
                p.Call("effect", v_target, (V)0L, (V)234L, (V)75L);
            ...
            else
            {
                if (V.T(V.B(V.T(((V)(v_type) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    {
                        p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 마레노를 가합니다.")));
                    }
                }
            }
            p.Call("effect", v_target, (V)0L, (V)234L, (V)75L);
