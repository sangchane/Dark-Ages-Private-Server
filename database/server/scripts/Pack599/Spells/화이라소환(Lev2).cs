...
{
    /// <summary>
    /// 화이라소환(Lev2) — 5.99 `Wizard.txt` 의 SPELL_화이라소환(Lev2) 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("화이라소환(Lev2)", "5.99표")]
    public class SpellD654C774B77CC18CD6580028004C0065007600320029 : SpellScript
    {
        public SpellD654C774B77CC18CD6580028004C0065007600320029(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            v_damage = ((((V)(p.Call("get_basemana", v_myid)) * (V)((V)1L))));
            ...
            p.Call("message", (V)3L, (V)"화이라소환(Lev2)를 외웠습니다.");
