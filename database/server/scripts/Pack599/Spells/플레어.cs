...
{
    /// <summary>
    /// 플레어 — 5.99 `Wizard.txt` 의 SPELL_플레어 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("플레어", "5.99표")]
    public class SpellD50CB808C5B4 : SpellScript
    {
        public SpellD50CB808C5B4(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            else
            {
                if (V.T(V.B(V.T(((V)(v_type) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    {
                        p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 플레어를 가합니다.")));
                    }
                }
            }
            p.Call("effect", v_target, (V)0L, (V)102L, (V)75L);
