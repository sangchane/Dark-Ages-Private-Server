...
{
    /// <summary>
    /// 홀리볼트 — 5.99 `성직자(비전직).txt` 의 SPELL_홀리볼트 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("홀리볼트", "5.99표")]
    public class SpellD640B9ACBCFCD2B8 : SpellScript
    {
        public SpellD640B9ACBCFCD2B8(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            if (V.T(((V)(p.Call("spell_exist", (V)"신성력강화")) == (V)((V)1L))))
            {
                ...
                v_damage = ((V)(p.Call("get_wis", v_myid)) * (V)((V)5L));
            }
            else
            {
                ...
                v_damage = ((V)(p.Call("get_wis", v_myid)) * (V)((V)2L));
            }
            ...
            {
                p.Call("effect", v_target, (V)0L, (V)23L, (V)75L);
            ...
            else
            {
                if (V.T(V.B(V.T(((V)(v_type) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    {
                        p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 홀리볼트를 가합니다.")));
                    }
                }
            }
            p.Call("message", (V)3L, (V)"홀리볼트를 외웠습니다.");
            p.Call("effect", v_target, (V)0L, (V)23L, (V)75L);
            p.Call("game_sound", (V)26L, (V)0L);
