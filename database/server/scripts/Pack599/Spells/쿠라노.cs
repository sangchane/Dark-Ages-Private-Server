...
{
    /// <summary>
    /// 쿠라노 — 5.99 `성직자(비전직).txt` 의 SPELL_쿠라노 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("쿠라노", "5.99표")]
    public class SpellCFE0B77CB178 : SpellScript
    {
        public SpellCFE0B77CB178(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            v_hill = ((V)(p.Call("get_wis", v_myid)) * (V)((V)20L));
            ...
            if (V.T(((V)(v_type) == (V)((V)3L))))
            {
                ...
                p.Call("message", (V)3L, (V)"쿠라노를 외웠습니다.");
                if (V.T(((V)(v_target) != (V)(v_myid))))
                {
                    p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 쿠라노를 외워주셨습니다.")));
