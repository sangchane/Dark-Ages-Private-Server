...
namespace Darkages.Storage.locales.Scripts.Pack599
{
    ...
    {
        public SpellC544C774C2A4BE14B7ECC2A4D2B8(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            {
                p.Call("effect", v_target, (V)0L, (V)101L, (V)75L);
            ...
            else
            {
                if (V.T(V.B(V.T(((V)(v_type) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    {
                        p.Call("message1", v_target, (V)3L, ((V)(p.Call("get_name")) + (V)((V)"님께서 아이스블러스트를 가합니다.")));
                    }
                }
            }
            p.Call("effect", v_target, (V)0L, (V)101L, (V)75L);
            p.Call("message", (V)3L, (V)"아이스블러스트를 외웠습니다.");
            p.Call("motion", (V)136L, (V)75L);
            p.Call("game_sound", (V)77L, (V)0L);
        }
    }
}
