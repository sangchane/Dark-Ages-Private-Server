...
{
    /// <summary>
    /// 텔레포트깃털 — 5.99 `CashI.txt` 의 아이템 사용 스크립트를 그대로 옮긴 것. 아이템이 스스로 지운다(`item_del`).
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-npcs.py` 가 다시 만든다.
    /// </remarks>
    [Script("ITEM_텔레포트깃털", "5.99표")]
    public class ItemD154B808D3ECD2B8AE43D138 : ItemScript
    {
        public ItemD154B808D3ECD2B8AE43D138(Item item) : base(item)
        {
        }
        ...
        public override void OnUse(Sprite sprite, byte slot)
        {
            ...
            if (V.T(((V)(((V)(p.Call("time")) - (V)(h_teleport))) < (V)((V)3L))))
            {
                return;
            }
