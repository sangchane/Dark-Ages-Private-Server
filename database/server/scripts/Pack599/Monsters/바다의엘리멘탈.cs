...
{
    /// <summary>
    /// 바다의엘리멘탈 — 5.99 `Mob_Spell.txt` 의 Monster_바다의엘리멘탈 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("Monster_바다의엘리멘탈", "5.99표")]
    public class MonsterBC14B2E4C758C5D8B9ACBA58D0C8 : SpellScript
    {
        public MonsterBC14B2E4C758C5D8B9ACBA58D0C8(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            if (V.T(((V)(p.Call("rand", (V)1L, (V)10L)) >= (V)((V)5L))))
            {
            ...
            else
            {
                ...
                v_mob = p.Call("get_mobxy", p.Call("get_last_object_xs", v_myid), p.Call("get_last_object_ys", v_myid));
                p.Call("group_hill", (V)0L, (V)236L);
                p.Call("effect", v_myid, (V)236L, (V)0L, (V)100L);
