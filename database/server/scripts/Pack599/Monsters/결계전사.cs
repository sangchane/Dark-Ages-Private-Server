...
{
    /// <summary>
    /// 결계전사 — 5.99 `Mob_Spell.txt` 의 Monster_결계전사 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("Monster_결계전사", "5.99표")]
    public class MonsterACB0ACC4C804C0AC : SpellScript
    {
        public MonsterACB0ACC4C804C0AC(Spell spell) : base(spell)
        {
        }
        ...
        public override void OnUse(Sprite sprite, Sprite target)
        {
            ...
            if (V.T(((V)(p.Call("rand", (V)1L, (V)10L)) >= (V)((V)6L))))
            {
                ...
                p.Call("effect", v_mob, (V)0L, (V)301L, (V)100L);
                p.Call("mob_say2", v_mob, (V)0L, (V)0L, (V)"완전방어!");
            ...
            else
            {
                ...
                v_mob = p.Call("get_mobxy", p.Call("get_last_object_xs", v_myid), p.Call("get_last_object_ys", v_myid));
                p.Call("mob_say2", v_mob, (V)0L, (V)0L, (V)"메가블레이드!");
                p.Call("game_sound", (V)18L, (V)0L);
                p.Call("effect", v_myid, (V)166L, (V)0L, (V)75L);
