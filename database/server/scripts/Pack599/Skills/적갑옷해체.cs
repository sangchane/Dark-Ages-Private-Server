...
{
    /// <summary>
    /// 적갑옷해체 — 5.99 `도적(비전직).txt` 의 SKILL_적갑옷해체 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("적갑옷해체", "5.99표")]
    public class SkillC801AC11C637D574CCB4 : SkillScript
    {
        public SkillC801AC11C637D574CCB4(Skill skill) : base(skill)
        {
        }
        ...
        public override void OnUse(Sprite sprite)
        {
            ...
            {
                p.Call("message", (V)3L, (V)"적갑옷해체를 시전하셧습니다.");
                p.Call("arm_del", v_target);
