...
{
    /// <summary>
    /// 정권 — 5.99 `무도가(비전직).txt` 의 SKILL_정권 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("정권", "5.99표")]
    public class SkillC815AD8C : SkillScript
    {
        public SkillC815AD8C(Skill skill) : base(skill)
        {
        }
        ...
        public override void OnUse(Sprite sprite)
        {
            ...
            if (V.T(((V)(p.Call("spell_exist", (V)"주먹단련")) == (V)((V)1L))))
            {
                ...
                v_damage = (((V)(((V)(p.Call("get_att_damage", v_myid)) / (V)((V)10L))) * (V)((V)25L)));
            }
            else
            {
                ...
                v_damage = (((V)(((V)(p.Call("get_att_damage", v_myid)) / (V)((V)10L))) * (V)((V)20L)));
            }
            ...
            if (V.T(V.B(!V.T(v_target))))
            {
                if (V.T(V.B(V.T(((V)(p.Call("istype", p.Call("get_front_char", v_myid))) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    p.Call("effect", v_target, (V)0L, (V)166L, (V)75L);  // 노바 이펙트(5.99: 0, 27, 속도 75)
