...
{
    /// <summary>
    /// 차크라어택 — 5.99 `도적(비전직).txt` 의 SKILL_차크라어택 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("차크라어택", "5.99표")]
    public class SkillCC28D06CB77CC5B4D0DD : SkillScript
    {
        public SkillCC28D06CB77CC5B4D0DD(Skill skill) : base(skill)
        {
        }
        ...
        public override void OnUse(Sprite sprite)
        {
            ...
            if (V.T(((V)(p.Call("get_mana", v_myid)) < (V)((V)230L))))
            {
                p.Call("message", (V)3L, (V)"사용하기에 마력량이적습니다. [필요마나 : 230이상]");
                return;
            }
            p.Call("manal_del", (V)"230");
            v_damage = (((V)(p.Call("get_att_damage", v_myid)) * (V)((V)4L)));
            v_damage = ((V)(v_damage) + (V)((((V)(p.Call("get_dex", v_myid)) * (V)((V)50L)))));
            ...
            if (V.T(V.B(!V.T(v_target))))
            {
                if (V.T(V.B(V.T(((V)(p.Call("istype", p.Call("get_front_char", v_myid))) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    p.Call("effect", v_target, (V)0L, (V)277L, (V)100L);
