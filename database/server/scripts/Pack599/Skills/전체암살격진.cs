...
{
    /// <summary>
    /// 전체암살격진 — 5.99 `Rogue.txt` 의 SKILL_전체암살격진 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("전체암살격진", "5.99표")]
    public class SkillC804CCB4C554C0B4ACA9C9C4 : SkillScript
    {
        public SkillC804CCB4C554C0B4ACA9C9C4(Skill skill) : base(skill)
        {
        }
            ...
            for (v_i = v_x1; V.T(((V)(v_i) <= (V)(v_x2))); v_i = ((V)(v_i) + (V)((V)1L)))
            {
                for (v_j = v_y1; V.T(((V)(v_j) <= (V)(v_y2))); v_j = ((V)(v_j) + (V)((V)1L)))
                {
                    ...
                    if (V.T(V.B(V.T(v_mob) && V.T(((V)(v_type) == (V)((V)1L))))))
                    {
                        ...
                        p.Call("effect", v_mob, (V)0L, (V)360L, (V)80L);
                    }
                }
            }
        }
