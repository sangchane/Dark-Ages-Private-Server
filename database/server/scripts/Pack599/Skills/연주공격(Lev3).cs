...
{
    /// <summary>
    /// 연주공격(Lev3) — 5.99 `Jigja.txt` 의 SKILL_연주공격(Lev3) 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("연주공격(Lev3)", "5.99표")]
    public class SkillC5F0C8FCACF5ACA90028004C0065007600330029 : SkillScript
    {
        public SkillC5F0C8FCACF5ACA90028004C0065007600330029(Skill skill) : base(skill)
        {
        }
        ...
        public override void OnUse(Sprite sprite)
        {
            ...
            v_x1 = p.Call("get_xs");
            v_y1 = p.Call("get_ys");
            v_dam = ((V)(p.Call("get_basemana", v_myid)) * (V)((V)3L));
