...
{
    /// <summary>
    /// 검투술(Lev2) — 5.99 `Warrior.txt` 의 SKILL_검투술(Lev2) 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("검투술(Lev2)", "5.99표")]
    public class SkillAC80D22CC2200028004C0065007600320029 : SkillScript
    {
        public SkillAC80D22CC2200028004C0065007600320029(Skill skill) : base(skill)
        {
        }
        ...
        public override void OnUse(Sprite sprite)
        {
            ...
            if (V.T(V.B(!V.T(v_target))))
            {
                if (V.T(V.B(V.T(((V)(p.Call("istype", p.Call("get_front_char", v_myid))) == (V)((V)3L))) && V.T(p.Call("get_map_pk")))))
                {
                    ...
                    p.Call("motion", (V)139L, (V)35L);
                    p.Call("effect", v_target, (V)0L, (V)111L, (V)75L);
