...
{
    /// <summary>
    /// 메가블레이드 — 5.99 `전사(비전직).txt` 의 SKILL_메가블레이드 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("메가블레이드", "5.99표")]
    public class SkillBA54AC00BE14B808C774B4DC : SkillScript
    {
        public SkillBA54AC00BE14B808C774B4DC(Skill skill) : base(skill)
        {
        }
        ...
        public override void OnUse(Sprite sprite)
        {
            ...
            v_x1 = p.Call("get_xs");
            v_y1 = p.Call("get_ys");
            v_dam = ((V)(((V)(p.Call("get_att_damage", v_myid)) / (V)((V)10L))) * (V)((V)28L));
            v_dam = ((V)(((V)(v_dam) + (V)(((V)(p.Call("get_con", v_myid)) * (V)((V)10L))))) + (V)((((V)(p.Call("get_att_damage", v_myid)) / (V)((V)2L)))));
            ...
            if (V.T(V.B(V.T((V.B(V.T(((V)(v_type1) == (V)((V)1L))) && V.T(((V)(v_type2) == (V)((V)1L)))))) && V.T((V.B(V.T(((V)(v_type3) == (V)((V)1L))) && V.T(((V)(v_type4) == (V)((V)1L)))))))))
            {
                ...
                p.Call("effect", v_mob1, (V)0L, (V)166L, (V)75L);
                p.Call("effect", v_mob2, (V)0L, (V)166L, (V)75L);
                p.Call("effect", v_mob3, (V)0L, (V)166L, (V)75L);
                p.Call("effect", v_mob4, (V)0L, (V)166L, (V)75L);
