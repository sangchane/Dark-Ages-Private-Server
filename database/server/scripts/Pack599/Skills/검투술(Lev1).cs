...
{
    /// <summary>
    /// 검투술(Lev1) — 5.99 `Warrior.txt` 의 SKILL_검투술(Lev1) 을 그대로 옮긴 것.
    /// </summary>
    /// <remarks>
    /// 손으로 고치지 말 것. `scripts/build-pack-abilities.py` 가 다시 만든다.
    /// </remarks>
    [Script("검투술(Lev1)", "5.99표")]
    public class SkillAC80D22CC2200028004C0065007600310029 : SkillScript
    {
        public SkillAC80D22CC2200028004C0065007600310029(Skill skill) : base(skill)
        {
        }
